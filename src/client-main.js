 ...
 *
 * Layout: injected into conversation.composer.dock, so it renders in-flow
 * directly below the input box and its stats/usage line (no fixed overlay).
